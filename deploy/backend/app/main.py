...
from controllers import (linee_controller, parcheggi_controller, simulazioni_controller, health_controller, mappa_controller, predizioni_controller)
...
app.include_router(mappa_controller.router, prefix="/mappa", tags=["Map"])
app.include_router(predizioni_controller.router, prefix="/predizioni", tags=["Predizioni"])
